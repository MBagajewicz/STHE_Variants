...
def Segmental_Smart_Enumeration(OF_NAME, LB_NAME, Fobj_within_LB, SEG_PAR, INC_OBJ, INC_VAR, constraint_lists, 
                                var_list, OF_VAR, candidates, problem_data, Type_Equipment, Active_Models_Constraints,
    ...
    if Fobj_within_LB:
        ...
        [LB_VAL, LB_Fobj_Best, LB_Args_Best] = Constraint_Eval.Constraint_Eval(LB_NAME[0], candidates, problem_data, 
    ...
    for i, interval_candidates in enumerate(segmented_candidates):
        ...
        sol_interval = Enumeration_Smart.Smart_Enumeration(OF_NAME, [LB_NAME[1]], Fobj_within_LB, Incumbent_Value,
                                                           INC_VAR, constraint_lists, var_list, OF_VAR, interval_candidates,
